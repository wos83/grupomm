...
type
  TFrmMain = class(TForm)
    ...
    procedure mapsDebugMarkerMouseUp(Sender: TObject; AEventData: TTMSFNCMapsEventData);
    procedure mapsDebugMarkerMouseLeave(Sender: TObject; AEventData: TTMSFNCMapsEventData);
    procedure mapsDebugMarkerMouseEnter(Sender: TObject; AEventData: TTMSFNCMapsEventData);
  ...
  private
    ...
    procedure doMarkerMouseUp(Sender: TObject; AEventData: TTMSFNCMapsEventData);
    procedure doMarkerMouseLeave(Sender: TObject; AEventData: TTMSFNCMapsEventData);
    procedure doMarkerMouseEnter(Sender: TObject; AEventData: TTMSFNCMapsEventData);
...
begin
  ...
  GMaps.Options.DefaultLatitude := cLat;
  GMaps.Options.DefaultLongitude := cLng;
  GMaps.Options.DefaultZoomLevel := cZoom;

  GMaps.Options.ShowZoomControl := True;
  GMaps.Options.ShowMapTypeControl := False;

  GMaps.Options.Console := False;
  GMaps.Options.Panning := True;

  GMaps.Options.ZoomOnDblClick := True;
  GMaps.Options.ZoomOnWheelScroll := True;

  GMaps.SetCenterCoordinate(cLat, cLng);
...
procedure TFrmMain.doMarkerMouseEnter(Sender: TObject; AEventData: TTMSFNCMapsEventData);
begin
  ShowMessage('mapsDebugMarkerMouseEnter');
end;

procedure TFrmMain.doMarkerMouseLeave(Sender: TObject; AEventData: TTMSFNCMapsEventData);
begin
  ShowMessage('mapsDebugMarkerMouseLeave');
end;

procedure TFrmMain.doMarkerMouseUp(Sender: TObject; AEventData: TTMSFNCMapsEventData);
begin
  ShowMessage('mapsDebugMarkerMouseUp');
end;
...
begin
  ...
  GMaps.APIKey := cGoogleMapsWebAPI;
  ...
  // Map.OnMarkerMouseUp := doMarkerMouseUp;
  // Map.OnMarkerMouseLeave := doMarkerMouseLeave;
  // Map.OnMarkerMouseEnter := doMarkerMouseEnter;

  GMaps.OnMapInitialized := doMapInitialized;
  GMaps.OnMarkerClick := doMarkerClick;
  GMaps.OnOverlayViewClick := doOverlayViewClick;
  GMaps.OnMarkerMouseUp := doMarkerMouseUp;
  GMaps.OnMarkerMouseLeave := doMarkerMouseLeave;
  GMaps.OnMarkerMouseEnter := doMarkerMouseEnter;
...
procedure TFrmMain.mapsDebugMarkerMouseEnter(Sender: TObject; AEventData: TTMSFNCMapsEventData);
begin
  ShowMessage('mapsDebugMarkerMouseEnter');
end;

procedure TFrmMain.mapsDebugMarkerMouseLeave(Sender: TObject; AEventData: TTMSFNCMapsEventData);
begin
  ShowMessage('mapsDebugMarkerMouseLeave');
end;

procedure TFrmMain.mapsDebugMarkerMouseUp(Sender: TObject; AEventData: TTMSFNCMapsEventData);
begin
  ShowMessage('mapsDebugMarkerMouseUp');
end;
