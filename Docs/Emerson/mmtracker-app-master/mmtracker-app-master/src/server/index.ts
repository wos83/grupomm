  ...
  Registry<
    {
      ...
      event: ModelDefinition<Record<string, unknown>>;
    },
    AnyFactories
  >
>;
...
const makeServer = ({ environment = 'test' } = {}): IMakeServer => {
  const server = createServer({
    ...
    serializers: {
      ...
      event: RestSerializer.extend({ embed: true }),
    },
        ...
        data: [
          {
            licensePlate: 'ABC1234',
            title: 'Bateria baixa',
            description: "'R. MAL. HENRIQUE BATISTA DUFFLES TEIXEIRA LOTT",
            iconType: 'emergency',
          },
          {
            licensePlate: 'ABC1234',
            title: 'Ultrapassou limite de velocidade',
            description: "'R. MAL. HENRIQUE BATISTA DUFFLES TEIXEIRA LOTT",
            iconType: 'event',
          },
          {
            licensePlate: 'ABC1234',
            title: 'Saiu da cerca virtual',
            description:
              "'R. MAL. HENRIQUE BATISTA DUFFLES TEIXEIRA LOTT, 279 - VILA MARINGA, JUNDIAÍ - SP",
            iconType: 'event',
          },
          {
            licensePlate: 'ABC1234',
          ...
          {
            licensePlate: 'ABC1234',
            title: 'Remoção da bateria principal',
            description: "'R. MAL. HENRIQUE BATISTA DUFFLES TEIXEIRA LOTT",
            iconType: 'emergency',
          },
          {
          ...
          },
          {
            licensePlate: 'ABC1234',
            title: 'Ultrapassou limite de velocidade',
            description: "'R. MAL. HENRIQUE BATISTA DUFFLES TEIXEIRA LOTTP",
            iconType: 'emergency',
          },
        ],
      }),
